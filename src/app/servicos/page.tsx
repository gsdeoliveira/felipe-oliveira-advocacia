...
import direitoEmpresarial from '@/assets/direito-empresarial.png'
import direitoCivil from '@/assets/direito-civil.png'
import direitoDaFamilia from '@/assets/direito-de-familia.png'
import direitoDoTrabalho from '@/assets/direito-do-trabalho.png'
  ...
  return (
    <>
      ...
      <div className="text-white p-[20px] lg:p-[50px]">
        <div className="flex flex-col lg:flex-row text-center lg:text-start gap-[20px] bg-gray rounded-[5px] mt-[90px]">
          <Image
          ...
          <div className="flex flex-col gap-[20px] p-[20px] lg:w-1/2">
            ...
            <ul className="lg:list-disc pl-[20px]">
        ...
        <div className="flex flex-col-reverse lg:flex-row text-center lg:text-start gap-[20px] bg-gray rounded-[5px] mt-[50px]">
          <div className="flex flex-col gap-[20px] p-[20px] lg:w-1/2">
        ...
        <div className="flex flex-col lg:flex-row text-center lg:text-start gap-[20px] bg-gray rounded-[5px] mt-[50px]">
          <Image
